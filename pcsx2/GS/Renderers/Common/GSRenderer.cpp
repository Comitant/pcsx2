...
static constexpr std::array<PresentShader, 6+4> s_tv_shader_indices = {
	...
	PresentShader::NEAREST_AA, PresentShader::SUPERSAMPLE_4xRGSS, PresentShader::SUPERSAMPLE_QUINCUNX, PresentShader::SUPERSAMPLE_JSSS};
